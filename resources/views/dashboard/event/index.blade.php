                    ...
                    <form method="post" action="{{url('admin/add/event')}}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 mt-2">
                                <lable class="label">Event Image (Multiple images)</lable>
                                <input type="file" multiple class="form-control" name="image[]" required>
                            </div>
                            ...
                            <div class="col-lg-6 mt-2">
                                <lable class="label">Event day title</lable>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{url("admin/seats/$event->id")}}">
                                                            <i style="color: skyblue;font-size: 20px"
                                                               class="fa fa-chain p-1"></i></a>
                                                        ...
                                                        <i style="color: blue;font-size: 20px;cursor: pointer"
                                                           ...
                                                           data-target="#exampleModal{{$event->id}}"></i>
                                                ...
                                                <div class="modal fade" id="exampleModal{{$event->id}}" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form method="post"
                                                                      action="{{url('admin/update/event/'.$event->id.'')}}"
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-12 mt-2">
                                                                            <lable class="label">Event start date
                                                                            </lable>
                                                                        ...
                                                                        <div class="col-lg-6 mt-2">
                                                                            <lable class="label">Event start time
                                                                            </lable>
