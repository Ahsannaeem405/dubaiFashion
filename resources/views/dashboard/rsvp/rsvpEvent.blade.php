...
@section('content')
    ...
    <main>
        <div class="content-body">
            <div class="col-lg-12">
                <a href="{{url('admin/rsvp')}}"> <button class="btn btn-primary my-2">BACK</button></a>
            </div>

            <div class="modal fade" id="exampleModaladdseat{{$rsvp->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div href="{{url('admin/all/approve/'.$rsvp->id.'')}}" class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form action= "{{url('admin/all/approve/'.$rsvp->id.'')}}"  method="post">
                                @csrf
                                <input type="text" required name="seatname" class="form-control" placeholder="seat name">
                        </div>
                    ...
                    <div class="col-12">
                        <div class="card p-2">
                            <div class="row">
                                ...
                                <a class="m-auto" data-toggle="modal" data-target="#exampleModaladdseat{{$rsvp->id}}" >  <button class="btn btn-primary ">Approve All</button>
                                </a>
...
@endforeach
                        ...
                        <div class="card p-2">
                            <div class="row text-center">
                                <a class="m-auto" href="{{url("admin/send/pdf/$id")}}">   <button class="btn btn-primary m-auto">Send Event detail Now</button>
                                </a>
                            </div>
                        </div>
                    </div>
