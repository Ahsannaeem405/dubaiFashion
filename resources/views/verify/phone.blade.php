    ...
    <div class="container">
        ...
        <div class="row m-0">
            ...
            <div class="col-lg-6 my-5"
                 style="margin-top:10% !important;%;border: 1px solid #d2d2f8;margin: auto;box-shadow: 2px 2px 2px 5px rgba(159,155,155,0.2);border-radius: 5px">
                ...
                <form action="{{url('final/step')}}" method="post">
                    ...
                    <div class="row ">
                        ...
                        <div class="col-lg-12" id="nobtn" style="display: none">
                            <button type="button" class="btn btn-secondary select3 w-100 mb-2  text-black" select="yes"
                                    style="background-color: #d0cccc;border: none;">NO
                            </button>
                        ...
                        <div class="col-lg-12 mt-2" style="display: none">
                            ...
                            <div class="input-group mb-2">
                                ...
                                <input name="phone" style="height: 38px;" value="{{$num}}" id="inlineFormInputGroup"
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 mt-2 mb-3 text-right">
                            ...
                            <button type="button" class="btn btn-success w-100 mb-2 select" select="no"
                                    style="background-color: black;border: none">NO
                            </button>
                            <button type="submit" class="btn btn-success w-100 select submit" select="yes"
                                    style="background-color: black;border: none">YES
                            </button>
                            <button type="submit" class="btn btn-success w-100 select2 submit" select="yes"
                                    style="display:none;background-color: black;border: none">SUBMIT
                            </button>
